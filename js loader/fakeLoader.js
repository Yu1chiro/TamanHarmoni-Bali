...
(function ($) {
    $.fakeLoader = function(options) {
        ...
        var spinner01 = '<div class="fl fl-spinner spinner1" style="display: flex; justify-content: center; align-items: center;"><img src="" alt="Logo" style="width: 20rem; height: 20rem; animation: zoomInOut 1s ease-in-out infinite;"></div>';
        ...
        var spinner03 = '<div class="fl fl-spinner spinner1" style="position: fixed; top: 0; left: 0; width: 100%; height: 100%; display: flex; justify-content: center; align-items: center; background: url(\'bgloader1.webp\') center/cover;"><img src="/logoloader1.webp" alt="Logo" style="width: 10rem; height: 10rem; animation: zoomInOut 1s infinite;"></div>';
        ...
        setTimeout(function () {
            window.location.href = "BaliHarmoni.html";
            $(el).fadeOut();
        }, settings.timeToHide);
    }; 
}(jQuery));
