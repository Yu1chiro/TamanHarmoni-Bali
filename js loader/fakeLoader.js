...
(function ($) {
    $.fakeLoader = function(options) {
        ...
        var spinner03 = '<div class="fl fl-spinner spinner1" style="position: fixed; top: 0; left: 0; width: 100%; height: 100%; display: flex; justify-content: center; align-items: center; background: url(\'bgloader.png\') center/cover;"><img src="logoloader.png" alt="Logo" style="width: 10rem; height: 10rem; animation: zoomInOut 1s infinite;"></div>';
